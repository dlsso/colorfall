...
Game.Play.prototype = {
	...
	bottomKill = killZones.create(0, h, 'platform');
	...
	game.physics.arcade.collide(player, bottomKill, this.scoreBonus, null, this);
	...
	updateCounter++
	if(updateCounter>180 && player.key === 'player') {player.loadTexture('player' + suffix, 1)}
